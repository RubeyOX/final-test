...
if(localStorage.getItem('added-to-Cart')=="[]"||localStorage.getItem('added-to-Cart')==undefined) {
  cartProduct=[]
} else {
...
function addToCart(id) {
  ...
  const addedP=takeout.find((item) => item.productId ==  id)
  let flag=false;
  let index=-1;
